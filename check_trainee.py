"""
check_trainee.py -- query PrefabInfo and print trainee status of vessels
"""
import os, sys, time
import grpc
...
def main():
    ...
    try:
        ...
        print("Trainee Status of Entities:")
        for eid, comps in sorted(entities.items()):
            if "vstep.prefabs.PrefabInfo" in comps:
                pi = comps["vstep.prefabs.PrefabInfo"]
                ...
                print(f"  Entity {eid} ('{disp}', MMSI: {mmsi}): code = {pi.code}, trainee = {pi.trainee}")
